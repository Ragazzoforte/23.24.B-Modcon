...
% \begin{Figure}
% \begin{center}
% \includegraphics[width=0.595\linewidth]{Pendulum v13 voor.png}
% % \caption{Foto van een gekko}
% \end{center}
% \end{Figure}
...
% \begin{align*}
% &\text{Unit of } I: \, \text{kg} \cdot \text{m}^2 \\
% &\text{Unit of } \ddot{\theta}: \, \text{rad/s}^2 \\
% &\text{Unit of } m: \, \text{kg} \\
% &\text{Unit of } g: \, \text{m/s}^2 \\
% &\text{Unit of } L: \, \text{m} \\
% &\text{Unit of } \theta: \, \text{rad}
% \end{align*}
